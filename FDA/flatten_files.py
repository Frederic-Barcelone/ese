"""
Copy Important FDA Package Files for RAG System
================================================
...
Output naming: {package_name}_{original_filename}
"""
...
# Configuration
SOURCE_DIR = "FDA_DATA/approval_packages"  # Adjust path as needed
TARGET_DIR = "FDA_TH"
...
def copy_package_files(package_path, target_dir):
    """
...
def main():
    ...
    print("="*70)
    print("FDA PACKAGE FILE COPIER FOR RAG SYSTEM")
    print("="*70)
    print(f"\nSource: {SOURCE_DIR}")
    ...
    for area_path in therapeutic_areas:
        ...
        for package_path in packages:
            stats = copy_package_files(package_path, target_path)
    ...
    with open(manifest_path, 'w') as f:
        f.write("FDA Package Files - Copy Manifest\n")
        f.write("="*70 + "\n\n")
