...
- **Latest results**: Drugs F1=93.2% (CADEC), Diseases F1=74.6% (NLP4RARE), Abbreviations F1=61.9% (NLP4RARE), Genes F1=65.3% (NLM-Gene + RareDisGene)
...
|-------------|-----------|------------|------------|--------|
| Abbreviations | NLP4RARE | 242 | 61.9% | Active evaluation |
| Diseases | NLP4RARE | 4,123 | 74.6% | Active evaluation |
