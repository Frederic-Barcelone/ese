# corpus_metadata/corpus_extraction/Z_tests/test_parsing_with_unstructured_local.py
...
def _bootstrap_import_path() -> Path:
    ...
    Este test vive en:
      corpus_metadata/corpus_extraction/Z_tests/...

    Así que añadimos a sys.path:
      corpus_metadata/corpus_extraction/
    """
    this_file = Path(__file__).resolve()
    pkg_root = this_file.parents[1]  # .../corpus_metadata/corpus_extraction
