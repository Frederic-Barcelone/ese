...
class ValidationLogger:
    ...
    def print_summary(self) -> None:
        ...
        print(f"  ✓ Validated:     {self.stats['validated']} ({self.stats['validated']/total*100:.1f}%)" if total else "  ✓ Validated:     0")
        print(f"  ✗ Rejected:      {self.stats['rejected']} ({self.stats['rejected']/total*100:.1f}%)" if total else "  ✗ Rejected:      0")
