...
from Z_utils.Z12_data_loader import load_nested_list_mapping
...
class Disambiguator:
    ...
    def __init__(self, config: dict):
        ...
        # Load disambiguation map from YAML (or accept override from config)
        self.ambiguity_map: Dict[str, Dict[str, List[str]]] = self.config.get(
            "ambiguity_map"
        ) or load_nested_list_mapping("ambiguity_map.yaml", "ambiguity_map")
